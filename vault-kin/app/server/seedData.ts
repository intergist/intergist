          ...
          groups: [
            {
              ...
              fields: [
                ...
                { id: "driversLicense", label: "Driver's License Number", type: "text", priority: "recommended", placeholder: "License number and state" },
                { id: "passportNumber", label: "Passport Number", type: "text", priority: "optional", placeholder: "Passport number and expiry" },
              ],
            },
            {
              id: "emergency",
        ...
        fieldSchema: {
          groups: [
            ...
            },
            {
              ...
              fields: [
                { id: "yearPurchased", label: "Year Purchased", type: "text", priority: "recommended", placeholder: "2015" },
